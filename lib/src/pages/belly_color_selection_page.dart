...
class BellyColorSelectionPage extends StatefulWidget {
  @override
  _BellyColorSelectionPageState createState() =>
      _BellyColorSelectionPageState();
}

class _BellyColorSelectionPageState extends State<BellyColorSelectionPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Consumer<ColorBelly>(
          builder: (BuildContext context, colorBelly, _) => Column(
            children: [
              Container(
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorBelly.setBellyColor = 'Amarillo';
                                  _selectRojo = true;
                                  _selectVioleta = true;
                                  _selectAzul = true;
                                  _selectVerde = true;
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorBelly.setBellyColor = 'Naranja';
                                  _selectRojo = true;
                                  _selectVioleta = true;
                                  _selectAzul = true;
                                  _selectVerde = true;
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorBelly.setBellyColor = 'Violeta';
                                  _selectAzul = true;
                                  _selectVerde = true;
                                  _selectCafe = true;
                                  _selectGris = true;
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorBelly.setBellyColor = 'Verde';
                                  _selectCafe = true;
                                  _selectGris = true;
                                  _selectBlanco = true;
                                  _selectNegro = true;
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorBelly.setBellyColor = 'Blanco';
                                  _selectNegro = true;
                                });
                                Navigator.pop(context);
                              }),
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorBelly.setBellyColor = 'Negro';
                                });
                                Navigator.pop(context);
                              }),
                          Container(
