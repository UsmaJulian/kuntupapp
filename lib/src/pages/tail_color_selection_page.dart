...
class TailColorSelectionPage extends StatefulWidget {
  @override
  _TailColorSelectionPageState createState() => _TailColorSelectionPageState();
}

class _TailColorSelectionPageState extends State<TailColorSelectionPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Consumer<ColorTail>(
          builder: (BuildContext context, colorTail, _) => Column(
            children: [
              Container(
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorTail.setTailColor = 'Amarillo';
                                  _selectRojo = true;
                                  _selectVioleta = true;
                                  _selectAzul = true;
                                  _selectVerde = true;
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorTail.setTailColor = 'Naranja';
                                  _selectRojo = true;
                                  _selectVioleta = true;
                                  _selectAzul = true;
                                  _selectVerde = true;
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorTail.setTailColor = 'Violeta';
                                  _selectAzul = true;
                                  _selectVerde = true;
                                  _selectCafe = true;
                                  _selectGris = true;
