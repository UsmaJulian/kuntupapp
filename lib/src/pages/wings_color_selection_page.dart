...
class WingsColorSelectionPage extends StatefulWidget {
  @override
  _WingsColorSelectionPageState createState() =>
      _WingsColorSelectionPageState();
}

class _WingsColorSelectionPageState extends State<WingsColorSelectionPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Consumer<ColorWings>(
          builder: (BuildContext context, colorWings, _) => Column(
            children: [
              Container(
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorWings.setWingsColor = 'Amarillo';
                                  _selectRojo = true;
                                  _selectVioleta = true;
                                  _selectAzul = true;
                                  _selectVerde = true;
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorWings.setWingsColor = 'Naranja';
                                  _selectRojo = true;
                                  _selectVioleta = true;
                                  _selectAzul = true;
                                  _selectVerde = true;
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorWings.setWingsColor = 'Violeta';
                                  _selectAzul = true;
                                  _selectVerde = true;
                                  _selectCafe = true;
                                  _selectGris = true;
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorWings.setWingsColor = 'Verde';
                                  _selectCafe = true;
                                  _selectGris = true;
                                  _selectBlanco = true;
                                  _selectNegro = true;
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorWings.setWingsColor = 'Blanco';
                                  _selectNegro = true;
                                });
                                Navigator.pop(context);
                              }),
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorWings.setWingsColor = 'Negro';
                                });
                                Navigator.pop(context);
                              }),
                          Container(
