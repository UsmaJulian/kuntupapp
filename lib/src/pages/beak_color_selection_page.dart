...
class BeakColorSelectionPage extends StatefulWidget {
  @override
  _BeakColorSelectionPageState createState() => _BeakColorSelectionPageState();
}

class _BeakColorSelectionPageState extends State<BeakColorSelectionPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Consumer<ColorBeak>(
          builder: (BuildContext context, colorBeak, _) => Column(
            children: [
              Container(
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorBeak.setBeakColor = 'Amarillo';
                                  _selectRojo = true;
                                  _selectVioleta = true;
                                  _selectAzul = true;
                                  _selectVerde = true;
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorBeak.setBeakColor = 'Naranja';
                                  _selectRojo = true;
                                  _selectVioleta = true;
                                  _selectAzul = true;
                                  _selectVerde = true;
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  colorBeak.setBeakColor = 'Violeta';
                                  _selectAzul = true;
                                  _selectVerde = true;
                                  _selectCafe = true;
                                  _selectGris = true;
